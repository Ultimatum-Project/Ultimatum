...
bool zu4_music_pack_available(int);
bool zu4_music_select_pack(int);
int zu4_music_active_pack();
int zu4_music_current_track();
bool zu4_music_is_enabled();
void zu4_music_set_enabled(bool);

...
# Usage:
#   ios/build-ios-sim.sh                    # clean app; first-run download
#   ios/build-ios-sim.sh /path/to/ultima4   # optionally embed a local copy
set -euo pipefail
...
# Original game data is deliberately absent by default. A local data directory
# remains available for developer-only builds.

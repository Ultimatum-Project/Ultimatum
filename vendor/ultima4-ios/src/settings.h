...
#define DEFAULT_BUMP_INTERACTIONS       1
#define DEFAULT_DIRECT_INTERACTIONS     1
#define DEFAULT_TAP_TO_WALK             1
#else
#define DEFAULT_BUMP_INTERACTIONS       0
#define DEFAULT_DIRECT_INTERACTIONS     0
#define DEFAULT_TAP_TO_WALK             0
#endif
...
typedef struct SettingsData {
    ...
    bool                bumpInteractions;
    bool                directInteractions;
    bool                tapToWalk;
    int                 dpadSize; // 0 Small, 1 Standard, 2 Large; device preference
    bool                flipControls;
    bool                fastCombatPresentation; // device preference, not a rule change
    int                 shrineTime;
    int                 soundVol;
